...
This example shows:
1. **Quote Request** with Position=1 (for BUY)
2. **GFI Response** with Side=2 (OFFER quote) - correct for BUY
3. **Execution** against OFFER quote with Side=1 (opposite of quote) - correct

**Expected behavior:** Position=1 → OFFER quotes → Client can BUY
**Actual behavior in example:** ✅ CORRECT

**Question:** If this flow is correct, why are BUY orders being rejected in practice?

**Possible issues to investigate:**
- Quote expiration timing (5 minute validity window)
- Quote cancellation between reception and execution
- Premium sign/value validation
- LP-specific execution requirements
